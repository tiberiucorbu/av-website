(function (window, angular) {
  ...
  app.factory('storyDataFactory', ['$http', '$log', '$httpParamSerializer', function ($http, $log, $httpParamSerializer) {
    ...
    return {
      ...
      deleteJson: function (params) {
        var deleteUrl = url + '?' + $httpParamSerializer(params);
        $log.debug('Preparing http DELETE at', deleteUrl);
